...
def reload_gradio_theme(theme_name=None):
    ...
    shared.gradio_theme.sd_grdui_modal_lightbox_toolbar_opacity = shared.opts.sd_grdui_modal_lightbox_toolbar_opacity
    shared.gradio_theme.sd_grdui_modal_lightbox_icon_opacity = shared.opts.sd_grdui_modal_lightbox_icon_opacity
