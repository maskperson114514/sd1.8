...
def on_app_started(callback):
    """register a function to be called when the grdui started, the gradio `Block` component and
...
def on_model_loaded(callback):
    """register a function to be called when the sd 1.8 model is created; the model is
