...
sd_repo_configs_path = os.path.join(paths.paths['sd 1.8'], "configs", "stable-diffusion")
sd_xl_repo_configs_path = os.path.join(paths.paths['sd 1.8 XL'], "configs", "inference")
