...
parser.add_argument("--ckpt", type=normalized_filepath, default=sd_model_file, help="path to checkpoint of sd 1.8 model; if specified, this checkpoint will be added to the list of checkpoints and loaded",)
parser.add_argument("--ckpt-dir", type=normalized_filepath, default=None, help="Path to directory with sd 1.8 checkpoints")
...
parser.add_argument("--medvram", action='store_true', help="enable sd 1.8 model optimizations for sacrificing a little speed for low VRM usage")
parser.add_argument("--medvram-sdxl", action='store_true', help="enable --medvram optimization just for SDXL models")
parser.add_argument("--lowvram", action='store_true', help="enable sd 1.8 model optimizations for sacrificing a lot of speed for very low VRM usage")
parser.add_argument("--lowram", action='store_true', help="load sd 1.8 checkpoint weights to VRAM instead of RAM")
...
parser.add_argument("--opt-channelslast", action='store_true', help="change memory type for sd 1.8 to channels last")
