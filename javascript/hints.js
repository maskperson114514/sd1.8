...
var titles = {
    ...
    "Masked content": "What to put inside the masked area before processing it with sd 1.8.",
...
onUiLoaded(function() {
    for (var comp of window.gradio_config.components) {
        if (comp.props.grdui_tooltip && comp.props.elem_id) {
            var elem = gradioApp().getElementById(comp.props.elem_id);
            if (elem) {
                elem.title = comp.props.grdui_tooltip;
            }
        }
    }
});
